<template>
  <div class="bread-cramps-holder">
    <div v-for="(item, index) in breadCrampsItems" :key="index" class="bread-cramps">
      <div
        class="numeration-of-pages"
        :class="{ 'active-page-name': item.path === breadCrampsActive }"
      >
        {{ index + 1 }}
      </div>
      <div
      ...
      <svg
        v-if="index < breadCrampsItems.length - 1"
        id="Capa_1"
        class="bread-cramps-arrows"
        version="1.1"
        x="0px"
        y="0px"
        fill="currentColor"
      ...
      >
        <path
          d="M265.171,125.577l-80-80c-4.881-4.881-12.797-4.881-17.678,0c-4.882,4.882-4.882,
