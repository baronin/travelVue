    ...
    <div class="flight-offer-row">
      <div class="result-wrapper">
        <div v-if="!changeStylesForPassengerInfoPage" class="column-content">
          <FlightsResultsItem :flight-cards-data="flightCardsData"></FlightsResultsItem>
        </div>
        ...
        <button class="btn is-arrow" :class="{ 'border-radius': isModalShown }">
          <transition name="ma">
      ...
      <div :class="{ 'is-hidden': !isModalShown }">
        <flight-info :ticket-data="flightCardsData" @closebtn="!changeHide"></flight-info>
      </div>
    </div>
  </div>
</template>
