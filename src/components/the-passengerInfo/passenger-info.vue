<template>
  <div class="container">
    ...
    <div v-if="dataFromApiExist" :key="'display-on-page'" class="passenger-info-holder">
      <div class="passenger-info-main">
        <the-card :flight-cards-data="itemCard"></the-card>
        <the-price-summary :card="itemCard" class="display-none-desktop"></the-price-summary>

        <form action="" class="form">
          <h2>Passenger Information</h2>
          <span class="bg-blue"
            >Passenger names must match passport for international travel or government issued photo
            ID for US domestic travel</span
          >
          ...
          <div class="row contact-info">
            ...
            <div class="column">
              <label for="number-input" class="form-group-label">Phone Number</label>
          ...
          <template>
            <contact-passenger-form
              :passenger-of-number="dataForApi.countPassenger.sumPassengers"
            ></contact-passenger-form>
          </template>
        </form>

        <the-button :modifier="[{ 'is-primary': true }]" @button-click="getReviewPage"
          >Book</the-button
        >
      </div>
    ...
    <div v-else :key="'display-on-page'" class="not-found">
...
export default {
  ...
  computed: {
    ...
    ...mapGetters('api', ['dataFromApi', 'dataFromApiExist', 'dataForApi']),
  },
  created() {
