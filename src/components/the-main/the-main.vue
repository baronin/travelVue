  ...
  >
    <div v-show="showSearchForms" :class="[{ 'bg-forms-result': changeStylesForResultPage }]">
      <div class="container">
        <div
          :class="
            changeStylesForResultPage
              ? [{ 'container-form-result': true }]
              : [{ 'container-form': true, 'bg-blue-grey': !changeStylesForResultPage }]
          "
        >
          <tabs>
            <tab name="Round trip">
            ...
            <tab name="One way"> One Way's content will be here </tab>
          </tabs>
        </div>
      </div>
    </div>
