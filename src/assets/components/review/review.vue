<template>
  <div class="container  padding-bottom">
    ...
    <div class="review-wrap flex">
      <img src="../../../assets/img/successful-booking.svg" alt="successful booking">
      ...
      <div class="flight-info">
        <div class="flex">
          <h3>{{dataForApi.originCity.cityName}}</h3>
          ...
          <h3>{{dataForApi.destinationCity.cityName}}</h3></div>
        <p>
      ...
      <span class="reference-number">Booking reference number: <b>NM23U6</b></span>
      <router-link to="/">
        <the-button :modifier="[{'is-secondary': true}]">Go to Home</the-button>
      </router-link>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    name: "review",
    components: {TheBreadCramps, TheButton},
    data() {
      return {
        dateFormat: 'D MMM',
        dateFormatYear: 'YYYY',
